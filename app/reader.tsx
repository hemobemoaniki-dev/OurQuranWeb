...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  progressWrap: { paddingHorizontal: 24, paddingTop: 10, paddingBottom: 4, gap: 10 },
  ...
  scroll: { paddingHorizontal: 16, paddingTop: 12, paddingBottom: 20, gap: 12 },
  ...
  translation: { padding: 16, gap: 10, borderRadius: 28, borderWidth: 1, borderColor: colors.borderStrong, backgroundColor: colors.surfaceSecondary },
