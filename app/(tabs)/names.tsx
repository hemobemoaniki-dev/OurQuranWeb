...
const useStyles = makeStyles((c) => ({
  ...
  nameMeaning: { color: c.onSurface, opacity: 0.78, fontSize: 13, lineHeight: 18, textAlign: "center", marginTop: 3 },
  ...
  detailCard: { width: 420, flexShrink: 0, alignSelf: "flex-start", marginTop: 45, borderRadius: 22, borderWidth: 1, borderColor: c.goldBorder, backgroundColor: c.surfaceSecondary, padding: 21, gap: 15, shadowColor: "#000000", shadowOpacity: 0.16, shadowRadius: 18, shadowOffset: { width: 0, height: 8 } },
  ...
  detailBody: { color: c.onSurface, fontSize: 15.5, lineHeight: 24, fontWeight: "500" },
