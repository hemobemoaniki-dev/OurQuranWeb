...
const useStyles = makeStyles(c => ({
  ...
  continueCard: { position: "relative", overflow: "hidden", padding: 18, borderRadius: 23, borderWidth: 1, borderColor: c.goldBorder, backgroundColor: "transparent", flexDirection: "row", alignItems: "center", gap: 14 }, continueName: { color: c.onSurface, fontSize: 23, lineHeight: 29, fontWeight: "900", letterSpacing: -0.4 }, play: { width: 52, height: 52, borderRadius: 18, borderWidth: 1.5, justifyContent: "center", alignItems: "center" },
}));
