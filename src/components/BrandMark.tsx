        ...
        <Image
          ...
          style={[
            ...
            tone === "gold"
              ? (Platform.OS === "web"
                  ? ({
                      filter: "sepia(1) saturate(7.5) hue-rotate(350deg) brightness(1.18) contrast(1.04) drop-shadow(0 0 10px rgba(255,207,70,0.50))",
                    } as any)
                  : ({ tintColor: "#F1C95A" } as any))
              : null,
          ]}
        />
      </View>
  ...
  return (
    ...
    >
      ...
      {tone === "gold" ? (
        <LinearGradient
          pointerEvents="none"
          colors={["rgba(255,239,167,0.0)", "rgba(255,211,72,0.14)", "rgba(255,164,22,0.02)"]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
          style={{
            position: "absolute",
            ...
            borderRadius: Math.round(size * 0.46),
      ...
      <Image
        ...
        style={[
          ...
          tone === "gold"
            ? (Platform.OS === "web"
                ? ({
                    filter: "sepia(1) saturate(7.5) hue-rotate(350deg) brightness(1.18) contrast(1.04) drop-shadow(0 0 14px rgba(255,205,64,0.58))",
                  } as any)
                : ({ tintColor: "#F1C95A" } as any))
            : null,
        ]}
